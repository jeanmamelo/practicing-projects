...
<body class="d-flex flex-column w-100 h-100 p-3 mx-auto text-center text-white bg-dark">
    <header class="mb-auto">
        <div>
            <h3 class="float-md-center mb-0 text-warning">Exercício 11</h3>
        </div>
    </header>
    <main class="px-3">
        <div class="container mb-3">
            <p class="mb-3">Crie um formulário de cadastro simples com nome, email, cpf e idade e exiba asinformações preenchidas na tela quando o formulário for submetido. Expliquetambém como todo o processo de envio de informações, processamento eresposta acontece na integração entre cliente e servidor.</p>
